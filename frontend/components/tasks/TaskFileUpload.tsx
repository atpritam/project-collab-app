...
import { FileText, X, Upload, AlertTriangle, Paperclip } from "lucide-react";
      ...
      {files.length < maxFiles && (
        <div className="">
          <UploadButton
            ...
            appearance={{
              button:
                "text-white py-2 px-4 rounded-md font-medium w-full border border-muted-foreground/20 bg-muted-foreground/10 hover:bg-muted-foreground/20",
